        ...
        <div className="row col-1 pt-5 w-100 gap-3 justify-content-center">
          ...
          <div className="col-md-5 d-flex flex-column align-items-center">
            <div className="bg-rgb(7, 16, 63) text-white rounded-3 shadow-lg p-4 w-100">
              <h2 className="text-center fs-2 fw-bold mb-4">Trading Assets</h2>
              ...
              <div className="row w-100 gap-3">
                ...
                >
                  ...
                  <h3 className="fs-5 fw-bold text-white mb-2">Commodities</h3>
                  <p className="text-white">Gold, silver, and raw materials</p>
                </div>
                ...
                >
                  ...
                  <h3 className="fs-5 fw-bold text-white mb-2">Mutual Funds</h3>
                  <p className="text-white">
